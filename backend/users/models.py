...
USERNAME_VALIDATOR = RegexValidator(regex='^[\\w.@+-]+$', message=message().invalid_username)
...
class User(AbstractUser):
    ...
    username = models.CharField(
        max_length=150, unique=True, verbose_name='Имя пользователя', validators=[USERNAME_VALIDATOR]
    )
